            ...
            <div className="p-6 border-b border-slate-100 mb-2">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="w-11 h-11 rounded-2xl border-2 border-slate-200 flex items-center justify-center text-slate-900 shadow-sm overflow-hidden bg-white">
                            <NextImage src="/logo.svg" alt="DKotoba Logo" width={44} height={44} className="w-full h-full object-contain p-1" />
                        </div>
                        <div>
